<?php
	//required files
	//.template/header.php
	//.functions/database_function.php
	//.template/footer.php

	
	//this file is changing data about book already residing in database
	//and after gathering data from database 
	//and it collects new data via post method
	//it calls edit_book.php
	//which initate changes
?>
